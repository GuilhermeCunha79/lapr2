...
| Chemical test | Teste Químico | Is a fast reaction performed in a test tube that gives a visual clue as evidence for a chemical reaction |
...
| Configuration File | Ficheiro de Configuração | It's a file used to configure parameters and initial settings for computer programs |
...
| Forecast | Previsão | It's a calculation or estimate of future events |
...
| Specialist doctor | Médico Especialista | It's a specialist on a certain area of medicine |
...
| Time horizon | Intervalo de Tempo | Duration of a time section without reference to when it starts or ends |
