...
| Step 4  		 |	... saving the selected category? | Result  | IE: object created in step 1 is classified in one Category.  |
| Step 5  		 |							 |             |                              |              
| Step 6  		 |	... validating all data (local validation)? | Result | IE: owns its data.| 
...
| Step 7  		 |	... informing operation success?| RecordResultUI  | IE: is responsible for user interactions.  | 
### Systematization ##
