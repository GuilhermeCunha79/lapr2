...
***AC5:** When registering a client with an already existing reference, the system must reject such operation with an error and the user must have the change to modify the typed reference.
...
-Typed Data: Employee ID; Organization Role; Name; Address; Phone Number; E-Mail; Standard Occupational Classification (SOC) code.
...
|:-------------  |:--------------------- |:------------|:---------------------------- |
| Step 1/Msg 1: register a new client                     | ... instantiating a new Client?               |  Receptionist             |                                                 |
|                                                         | ... interacting with the actor?               |  RegisterClientUI         |                                                 |
|                                                         | ... coordination the US?                      |  RegisterClientController |                                                 |
...
| Step 3/Msg 3: insert the data                           |	... saving the input data                     |  Client                   | IE: object created in step 1 has its own data.  |
...
| Step 5/Msg 5: confirms the data                         | ... saving the registered client?	          |  Company                  | IE: records all the Client objects              |
