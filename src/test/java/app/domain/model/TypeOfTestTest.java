...
public class TypeOfTestTest {
    ...
    public void checkToStringMethod() {
        TypeOfTest tot1 = new TypeOfTest("53436", "RNA remnants", "cotton swab", pc);
        String expected= String.format("Type of Test:%nCode: 53436%nDescription: RNA remnants%nCollecting Method: cotton swab%nParameter Category(ies):%nParameter Category -> Code: 34567 | Name: Src |%n");
