...
public class ClientTest {
    ...
    public void checkIfTwoClientsAreDifferents() {
        ...
        Client ct02 = new Client("Tomás", 1234567890123456L,1234567890, 1234567890, "23/12/98", "Female", 12345678901L, "tomas@isep.ipp.pt");
    ...
    public void checkToStringMethod(){
        Client ct01 = new Client("Tomás", 1234567890123456L,1234567890,1234567890, "23/12/98","male",12345678901L,"tomas@isep.ipp.pt");
        String expected = "Client:%nName: Tomás%nCitizen Card Number: 1234567890123456%nNHS number: 1234567890%nTIN number: 1234567890%nBirth date: 23/12/98%nSex: male%nPhone number: 12345678901%nEmail: tomas@isep.ipp.pt";
    ...
    @Test (expected = IllegalArgumentException.class)
    public void checkEqualsJustCitizenCardNumberEqual() {
