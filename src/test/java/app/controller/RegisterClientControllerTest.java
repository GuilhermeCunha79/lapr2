...
public class RegisterClientControllerTest {
    ...
    public void ensureNonAlphaNumericNameAreNotAccepted() {
        ctrl.newClient("Tom<s@", "1234567890123456", "1234567890", "1234567890", "23/12/2002", "male", "12345678901", "tomas@isep.ipp.pt");
    }
    ...
    public void ensureCitizenCardNumberCannotBeCreatedBlank() {
        ctrl.newClient("Tomás", "","1234567890","1234567890","23/12/2002","male","12345678901", "tomas@isep.ipp.pt");
    }

    @Test
    public void ensureCitizenCardNumberCanHave16Char() {
        assertTrue(ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2002","male","12345678901", "tomas@isep.ipp.pt"));
    }
    ...
    public void ensureTinCannotBeHaveMoreAndLessThan10Char() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","12345678901","23/12/2002","male","12345678901", "tomas@isep.ipp.pt");
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureDateOfBirthCannotBeCreatedBlank() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","","male","12345678901", "tomas@isep.ipp.pt");
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureDateOfBirthCannotBeInWrongFormat() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","2002/23/12","male","12345678901", "tomas@isep.ipp.pt");
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureSexCannotBeCreatedBlank() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2002","","12345678901", "tomas@isep.ipp.pt");
    }

    @Test
    public void ensureSexCanBeMaleFemale() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2002","male","12345678901", "tomas@isep.ipp.pt");
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureSexCannotBeDifferentThanMaleFemale() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2002","madeira","12345678901", "tomas@isep.ipp.pt");
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensurePhoneNumberCannotBeCreatedBlank() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2002","male","", "tomas@isep.ipp.pt");
    }
    ...
    public void ensurePhoneNumberCannotHaveMoreLessThan11Char() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2002","male","123456789101", "tomas@isep.ipp.pt");
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureEmailCannotBeCreatedBlank() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2002","male","12345678901", "");
    }
    ...
    public void ensureEmailCannotBeCreatedInInvalidFormat() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2002","male","12345678901", "tomasisep.ipp.pt");
    }

    @Test
    public void ensureCannotCreateSameClientTwice() {
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2000","male","12345678901","tomas@isep.ipp.pt");
        ctrl.saveClient();
        ctrl.newClient("Tomás", "1234567890123456","1234567890","1234567890","23/12/2000","male","12345678901","tomas@isep.ipp.pt");
