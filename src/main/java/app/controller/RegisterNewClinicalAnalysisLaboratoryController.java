...
public class RegisterNewClinicalAnalysisLaboratoryController {
     ...
     */
        public RegisterNewClinicalAnalysisLaboratoryController() { this(App.getInstance().getCompany().getClinicalAnalysisLaboratoryStore());
    }
     ...
     */
        ...
        public List<ClinicalAnalysisLaboratory> getClinicalAnalysisLaboratoryList(){ return App.getInstance().getCompany().getClinicalAnalysisLaboratoryStore().getClinicalAnalysisLaboratoryList();
        }
    }
