    ...
    public boolean registerClient() {
        ...
        do {
            try {
                ...
                String cltSex = Utils.readLineFromConsole("Introduce client's sex: "); //NECESSÁRIO POR OPÇÃO
                ...
                if (created) {
                    System.out.printf("\nConfirm the client data: \nName: %s\nNHS Number: %s\nTIN Number: %s\nDate of Birth: %s\nSex: %s\nPhone Number: %s\nEmail: %s", cltName, cltCitizenCardNumber, cltNhs, cltTin, cltDateOfBirth, cltSex, cltPhoneNumber, cltEmail);
